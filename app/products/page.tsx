        ...
        <tbody>
          {productsList.map(item => (
            <tr key={item._id}>
              <td>{item.title}</td>
              <td>
                <Link className="btn-light-blue" href={`/products/edit/${item._id}`}>
                ...
                <div className="delete-button btn-red" onClick={() => handleOpenModal(item._id)}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
          ...
          {showDeleteModal && (
            <div className="modal">
              <div className="modal-content">
                ...
                <p>Are you sure you want to delete this product (id: ${selectedDeleteItem} )?</p>
